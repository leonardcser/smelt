...
This workspace is in the middle of a multi-phase architectural refactor. Read
`refactor/README.md` first — it indexes the rest and carries the operating
rules.
...
@refactor/TRACE.md @refactor/TESTING.md @refactor/P10.md
