...
| `app/confirms.rs`                         | 71   | `Confirms` subsystem (pending tool-approval requests)       | kept                | P2.a.3    | partial | `is_clear()` lands; engine-drain gate hookup rides EngineBridge (P2.a.11). |
