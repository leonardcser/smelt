...
| `lua/api/dispatch.rs`                     | 392  | Lua FFI dispatch (cmd / keymap / task / tools / statusline / spawn) | restructured | P3.b      | partial | `timer` / `cell` / `au` registrations carved out into sibling files; remaining six namespaces still multiplexed here. |
