...
| --------------------- | ---- | --------------------------------------------- | ------------ | --------- | ------- | --------------------------------------------------------------------------------------------------- |
| `buffer.rs`           | 1490 | Lines, namespaced extmarks, marks, virtual text | restructured | P1.a    | partial | Extmark + namespace + `YankSubst` + `yank_text_for_range` + `wrap_at` cache landed; `attach(spec)` parser hooks pending |
...
| `theme.rs`                                | 394  | Theme constants module                                      | deleted             | P1.0      | pending | Replaced by Theme registry in `ui` (tracked task `20260426-083607`); deferred from P0                       |
