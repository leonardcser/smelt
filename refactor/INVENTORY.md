...
| `app/confirms.rs`                         | 55   | `Confirms` subsystem (pending tool-approval requests)       | kept                | P2.a.3    | partial | oneshot::Sender swap + `is_clear()` gate ride P2.a.3b alongside `EngineBridge`. |
