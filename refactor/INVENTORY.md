...
| `app/mouse.rs`                            | 691  | Mouse routing + drag + scrollbar                            | restructured        | P1/P2     | partial | Viewport reads route through `Ui::win(id)?.viewport`; click-count + scrollbar drag + per-pane dispatch fold via UiHost across P2.b.4c.2-c.6. |
