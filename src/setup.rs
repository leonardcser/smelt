...
fn default_config_lua() -> String {
    ...
    lua.push_str("-- Generated by `smelt config default`. Copy to your smelt config directory\n");
    lua.push_str(
        "-- as init.lua and edit the values you want to override. All uncommented settings\n",
    );
