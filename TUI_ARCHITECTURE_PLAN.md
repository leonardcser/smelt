...
- ✅ **User message block cursor offset by 1 char** — fixed: mouse clicks snap past non-selectable cells via `snap_col_to_selectable`. Block padding marked non-selectable.
