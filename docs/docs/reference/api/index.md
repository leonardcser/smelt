...
**Coverage:** 82 namespace(s), 446 function(s), 83 class(es), 11 alias(es).
...
- [`smelt.tools`](tools.md) - 8 function(s)
...
- [`smelt.session`](session.md) - 32 function(s) - 1 internal function(s)
...
- [`smelt.terminal`](terminal.md) - 6 function(s)
