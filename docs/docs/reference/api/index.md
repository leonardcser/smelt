...
**Coverage:** 74 namespace(s), 395 function(s), 82 class(es), 10 alias(es).
...
- [`smelt.transcript.defaults`](transcript_defaults.md) - 29 function(s)
...
- [`smelt.session`](session.md) - 27 function(s)
