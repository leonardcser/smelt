...
**Coverage:** 60 namespace(s), 239 function(s), 30 class(es), 8 alias(es).
...
- [`smelt.lifecycle`](lifecycle.md) — 3 function(s)
...
- [`smelt.overlay.layout`](overlay_layout.md) — 4 function(s)
...
- [`smelt.text`](text.md) — 4 function(s)
