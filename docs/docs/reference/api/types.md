...
Sticky handle returned by `smelt.cell(name)`. Setters return the handle for
...
Name of a reactive cell. Open alias - plugin-defined cells declared via
`smelt.cell.new` are accepted alongside the well-known runtime cells listed
here.
...
`"cursor_pos"` \| `"cwd"` \| `"errors"` \| `"history"` \| `"history_epoch"` \|
`"input_epoch"` \| `"input_submit"` \| `"keymap_pending"` \| `"model"` \|
`"now"` \| `"notification_visible"` \| `"permission_pending"` \| `"reasoning"`
\| `"running_procs"` \| `"session_ended"` \| `"session_epoch"` \|
`"session_started"` \| `"session_title"` \| `"shutdown"` \| `"spinner_frame"` \|
`"stream_delta"` \| `"task_label"` \| `"tokens_used"` \| `"tool_end"` \|
`"tool_start"` \| `"tps"` \| `"turn_complete"` \| `"turn_end"` \| `"turn_error"`
\| `"turn_start"` \| `"vim_mode"` \| `"work_busy"` \| `"work_elapsed_ms"` \|
`"work_label"` \| `"work_outcome"` \| `"work_retry_attempt"` \|
