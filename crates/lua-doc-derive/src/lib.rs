...
// ═══════════════════════════════════════════════════════════════════════
//  #[lua_module]  —  marker attribute for Lua registration functions.
//  Currently a no-op; kept as documentation so it's easy to spot which
//  Rust functions define the Lua API surface.
// ═══════════════════════════════════════════════════════════════════════
