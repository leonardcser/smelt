...
pub(super) fn render_edit_output(
    ...
    } else if let Some(crate::core::transcript_cache::ToolOutputRenderCache::InlineDiff(cache)) =
...
pub(super) fn render_notebook_output(
    ...
    } else if let Some(crate::core::transcript_cache::ToolOutputRenderCache::NotebookEdit(ref nb)) =
        output.render_cache
    {
