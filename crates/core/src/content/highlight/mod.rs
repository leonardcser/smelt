...
pub use inline::{
    emit_inline_spans, inline_spans_width, lower_inline_events, measure_markdown_table,
    parse_inline_spans, render_markdown_table, wrap_inline_spans, InlineSpan, InlineStyle,
};
pub use syntax::{
